...
│   │
│   ├── semantic/                  # Member C - Vector embeddings
│   │   ├── __init__.py
│   │   ├── embedder.py            # sentence-transformer wrapper
│   │   ├── similarity.py          # cosine similarity / faiss search
│   │   └── semantic_pipeline.py
│   │
│   ├── ranking/                   # Member D - Aggregation & fusion
│   │   ├── __init__.py
│   │   ├── score_fusion.py        # weighted combination
│   │   ├── ranker.py              # sorting, top-100 selection
│   │   ├── reasoning_generator.py # generates candidate reasoning strings
│   │   └── output_validator.py    # validates final CSV structure
│   │
│   └── utils/
│       ├── __init__.py
...
│
├── notebooks/                     # EDA and weight tuning
│   ├── eda.ipynb
│   └── weight_tuning.ipynb
│
...
├── README.md
├── METHODOLOGY.md
└── phases.png                     # development workflow diagram
```
